...
(function () {
    "use strict";
    EduCore.register({
        module: "SM.Edu.Core.Modules.Promesas.PromesaProvider",
        libraries: {
            SM: "SM"
        },
        definition: obtenerPromesaProvider
    });
    function obtenerPromesaProvider(sandBox) {
        var SM = sandBox.libraries.SM;
